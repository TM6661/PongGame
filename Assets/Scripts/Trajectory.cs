...
public class Trajectory : MonoBehaviour
{
    ...
    //Bola "Bayangan yang akan di tampilkan di titik tumbukan"
    ...
    void Update()
    {
        //Inisiasi status pantulan lintasan, yang hanya ditampilkan ketika bertubrukan dengan object tertentu
        bool drawBallAtCollision = false;

        //Titik tumbukan untuk menggambarkan ballAtCollision
        Vector2 offsetHitPoint = new Vector2();

        //Tentukan titik tumbukan dengan deteksi pergerakan lingkaran
        RaycastHit2D[] circleCastHit2DArray = Physics2D.CircleCastAll(ballRigidBody2d.position,
            ballCollider.radius, ballRigidBody2d.velocity.normalized);
        ...
        foreach(RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            {
                //Garis lintasan akan digambar dari titik tengah bola saat ini ke titik tengah bola pada saat tumpukan,
                //yaitu sebuah titik yang di offset dari titik tumbukan berdasar vector normal titik tersebut sebesar jari2x bola

                //Tentukan titik tumbukan 
                Vector2 hitPoint = circleCastHit2D.point;

                //Tentukan normal titik tumbukan
                Vector2 hitNormal = circleCastHit2D.normal;

                //Tentukan offsetHitPoint, yaitu titik tengah bola saat bertumbukan
                ...
                //Jika bukan sidewall, gambar pantulannya
